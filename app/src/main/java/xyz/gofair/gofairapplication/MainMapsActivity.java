...
public class MainMapsActivity extends AppCompatActivity implements
    ...
    static    double lon=0.00;
    static double lat2=0.00;
    static double lon2=0.00;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   mLocationMarkerText = (TextView) findViewById(R.id.locationMarkertext);
        mLocationAddress = (AutoCompleteTextView) findViewById(R.id.autoCompleteTextView);
    ...
    private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback
        ...
        public void onResult(PlaceBuffer places) {
            ...
            mLocationAddress.setText(place.getName()+" "+place.getAddress()+" "+lat2+lon2);


           /* mMap.addMarker(new MarkerOptions().position(latLng).title("Your Destination"));
            mMap.moveCamera(CameraUpdateFactory.newLatLng(latLng));
           */
//            Intent i = new Intent(MainMapsActivity.this, SearchActivity.class);
//            Bundle b = new Bundle();
//            b.putDouble("lat", lat);
//            b.putDouble("lon",lon);
//            b.putDouble("lat2",lat2);
//            b.putDouble("lon2",lon2);
//            i.putExtras(b);
//
//            startActivity(i);
...
//                        startService(intent);
    ...
    public void onSearch(View view) {
        ...
        String loaction = mAutocompleteTextView.getText().toString();
...
//        // Add a marker in Sydney and move the camera
        LatLng Dhaka = new LatLng(23.727683, 90.410578);
        LatLng Rampura = new LatLng(23.768218, 90.425142);
    ...
    private void getAddress(double latitude, double longitude) throws IOException {
        ...
        try {
            ...
            if (addresses != null && addresses.size() > 0) {
              ...
              //  mLocationMarkerText.setText("Destination: "+address +" "+knownName);
                // mLocationAddress.setText("Destination: "+address +" "+knownName);
                drawroute();
            }
        } catch (IOException e) {
...
//            mLocationMarkerText.setText("Destination: "+"Lat : " + location.getLatitude() + "," + "Long : " + location.getLongitude());

            origin = new LatLng(location.getLatitude(), location.getLatitude());
    ...
    class AddressResultReceiver extends ResultReceiver {
        ...
        /**
         * Receives data sent from FetchAddressIntentService and updates the UI in MainActivityWithAutoSearch.
         */
        @Override
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_AUTOCOMPLETE) {
            if (resultCode == RESULT_OK) {
                ...
                CameraPosition cameraPosition = new CameraPosition.Builder()
                        .target(latLong).zoom(20f).tilt(70).build();
